...
public class converter {
	...
	public static   GridPane Main_pane=new GridPane();
		...
		try {
			...
			pane.setPadding(new Insets(3, 3, 3, 3));
             ...
             form.root.getChildren().add(form.pane);
	            ...
	            slide.setOnFinished(e -> form.root.getChildren().remove(form.pane_convert));
	            slide.play();
            ...
            MenuItem exitMenuItem = new MenuItem("Exit");
 			...
 			pane.add(menubar, 0, 0,1,4);
 			
              menubar.setStyle("-fx-background-color: transparent;-fx-font-family: Baumans;-fx-font-size: 30px;-fx-text-fill: #00CCFF;");
			...
			txt2.setFont(Font.font("Helvetica", FontWeight.BOLD, 30));
			txt2.setStyle(
					"-fx-background-color: linear-gradient(gray, gray); -fx-background-radius: 30;-fx-background-insets: 0;-fx-text-fill: white;");
			...
			txt.setFont(Font.font("Kristen ITC", FontWeight.EXTRA_LIGHT, 30));
 			txt2.setFont(Font.font("Kristen ITC", FontWeight.EXTRA_LIGHT, 30));
 			txt.setStyle(
					"-fx-background-color: #3a476a;-fx-text-fill: white;");
 			txt2.setStyle(
					"-fx-background-color: #3a476a;-fx-text-fill: white;");
 			cmb.setValue("choose");
 			cmb2.setValue("choose");
 			cmb3.setValue("choose");
			...
			pane2.add(btns[12], 2, 4);
 			pane2.setPadding(new Insets(3, 3, 3, 3));
			...
			for (int i = 0; i < 13; i++) {
				...
				btns[i].prefHeightProperty().bind(scene.heightProperty().divide(6.3));
			...
			cmb.prefWidthProperty().bind(scene.widthProperty().divide(2));
			cmb2.prefWidthProperty().bind(scene.widthProperty().divide(2));
			cmb3.prefWidthProperty().bind(scene.widthProperty().divide(2));
			txt2.prefWidthProperty().bind(scene.widthProperty().divide(2));
			txt.prefWidthProperty().bind(scene.widthProperty().divide(2));
  			 return Main_pane;
...
*/
	...
	public static void  power(){
    	   ...
    	   switch (cmb2.getValue()) {
      		...
      		case "watts":
      			if (cmb3.getValue() == "watts") {
      				txt2.setText(txt.getText());
      			}
      			else if (cmb3.getValue() == "kiloWatts") {
      				double value = Double.parseDouble(txt.getText());
      				value =(value/1000 );
      				txt2.setText(string_format(value));
      			}
      			else if (cmb3.getValue() == "Horspower (us)") {
      				double value = Double.parseDouble(txt.getText());
      				value =(value/745.699872 );
      				txt2.setText(string_format(value));
      			}
    	   break;
      		case "kiloWatts":
